...
import com.nice295.fridgeplease.camera.CameraSource;
import com.nice295.fridgeplease.camera.CameraSourcePreview;
...
public final class OcrCaptureActivity extends BaseActivity {
    ...
    public static final String Url = "Url"; //khlee
    ...
    private HashMap<String, String> mItems; //khlee
    private TagView mTagsView;
    private ArrayList<String> mTempItemArray;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            for (int idx = 0; idx < mTempItemArray.size(); idx++) {
                addNewMyItem(mTempItemArray.get(idx), 0, mItems.get(mTempItemArray.get(idx).toLowerCase()));
            }
    ...
    public void addItem(String item) {
        ...
        if (mTempItemArray.contains(item) == false) {
            mTempItemArray.add(item);
    ...
    private boolean onTap(float rawX, float rawY) {
        ...
        if (graphic != null) {
            ...
            if (text != null && text.getValue() != null) {
                ...
                data.putExtra(Url, getUrl(text.getValue()));
    ...
    private String getUrl(String input) {
        return mItems.get(input);

        /*
        for(Word word : mWords){
            if(word.getWord().equalsIgnoreCase(input)){
