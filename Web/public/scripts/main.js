 ...
 */
function createPostElement(postId, name, time, pic) {
  var html1 = 
  ...
  // Set values.
  postElement1.getElementsByClassName('item-name')[0].innerText = name;
  postElement1.getElementsByClassName('item-time')[0].innerText = time +" 일";
...
function startDatabaseQueries() {
  ...
  var fetchPosts = function(postsRef, sectionElement) {
    postsRef.on('child_added', function(data) {
      ...
      console.log('child_added:' + data.val().time);      
